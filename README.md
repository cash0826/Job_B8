...
- Update event/contact was developed in the backend and partially in the front end. I excluded the update UI flow because there are only 3 inputs to edit. Delete/Add achieve the same end results in the same time. 
